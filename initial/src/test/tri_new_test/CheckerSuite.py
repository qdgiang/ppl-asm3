...
########################## Binary ######################## 12-20
    ...
    def test_binary1(self):
        ...
        """
        expect = "Type Mismatch In Expression: BinaryOp(==,IntLit(1),FloatLit(2.1))"
        self.assertTrue(TestChecker.test(input,expect,412))
    def test_binary2(self):
        """Simple program: int main() {} """
        input = """
            Class C{ fffe(){ Var c:Float = 1+True; } }"""
    ...
    def test_binary4(self):
        """Simple program: int main() {} """
        input = """
            Class C{ e(){ Var c:String = "abc" % "def"; } }
                """
        expect = "Type Mismatch In Expression: BinaryOp(%,StringLit(abc),StringLit(def))"
        self.assertTrue(TestChecker.test(input, expect, 415))

    def test_binary5(self):
        """Simple program: int main() {} """
        input = """
            Class C{ e(){ Var c:String = "abc" +. "def"; Return c;} }
            Class D{
                method(c: C){
                    Return 1 + c.e();
                }
                ...
                """
        expect = "Type Mismatch In Expression: BinaryOp(+,IntLit(1),CallExpr(Id(c),Id(e),[]))"
    ...
    def test_binary6(self):
        ...
        input = """
            Class A {
                $foo3(x:Float; y:String){ Return y; }
            }
            Class BB{
                foo2(){ Var g:String = A::$foo3(1, "a") + 1; }
            }"""
        expect = "Type Mismatch In Expression: BinaryOp(+,CallExpr(Id(A),Id($foo3),[IntLit(1),StringLit(a)]),IntLit(1))"
        self.assertTrue(TestChecker.test(input, expect, 417))

    def test_binary7(self):
        """Simple program: int main() {} """
        input = """
                        Class A {
                           $fooExp2(x:Float; y:String){ Return x; }
                        }
                        Class BB{
                            foo2(){
                                e = A::$fooExp2(1, "a") + 1;
    ...
    def test_binary8(self):
        ...
        input = """
                        ...
                        Class BB{
                            foo2(){
                                Var e : String = (New A()).a - 7;
                            }
                        }"""
        expect = "Type Mismatch In Statement: VarDecl(Id(e),StringType,BinaryOp(-,FieldAccess(NewExpr(Id(A),[]),Id(a)),IntLit(7)))"
        self.assertTrue(TestChecker.test(input, expect, 419))
       

    def test_binary9(self):
        """Simple program: int main() {} """
        input = """
                Class A {
                    Var a:Int = 1 + 2.0;
                        ...
                        """
        expect = "Type Mismatch In Statement: VarDecl(Id(a),IntType,BinaryOp(+,IntLit(1),FloatLit(2.0)))"
...
# ########################## Constant ######################## 21-30
    ...
    def test_constant9(self):
        ...
        """
        expect = "Cannot Assign To Constant: AssignStmt(FieldAccess(Id(A),Id($x)),CallExpr(Id(A),Id($foo),[]))"
    ...
    def test_callExpr5(self):
        ...
        """
        expect = "Type Mismatch In Expression: BinaryOp(%,FloatLit(1.0),CallExpr(Id(B),Id($getA),[Id(b)]))"
    ...
    def test_callExpr6(self):
        ...
        """
        expect = "Type Mismatch In Expression: BinaryOp(%,FloatLit(1.0),CallExpr(Self(),Id(getA),[Id(b)]))"
    ...
    def test_fieldAccess2(self):
        ...
        """
        expect = "Illegal Member Access: FieldAccess(Id(B),Id(x))"
        self.assertTrue(TestChecker.test(input,expect,452))

    def test_fieldAccess3(self):
        input = """
        Class B{ Var $x: Int = 1; }
        Class A{
            Var x: Int = 1;
    ...
    def test_fieldAccess7(self):
        ...
        Class Program {main(){Return;}}
        """
        expect = "Illegal Constant Expression: FieldAccess(Id(b),Id(x))"
        self.assertTrue(TestChecker.test(input,expect,457))

    def test_fieldAccess8(self):
        input = """
        Class B{ Val x: Float = 1; }
        Class A{
            Var x: Int = 1;
            method(b: Int){
                Val y: Int = b.x;
    ...
    def test_fieldAccess9(self):
        ...
        """
        expect = "Type Mismatch In Statement: VarDecl(Id(y),IntType,FieldAccess(Id(B),Id($x)))"
        self.assertTrue(TestChecker.test(input,expect,459))

    def test_fieldAccess10(self):
        input = """
        Class C{ Var x: Int = 1; }
        Class A{
            Var x: Int = 1;
    ...
    def test_methodConst1(self):
        ...
        Class A{
            Val $x: Int = 1;
            $method(a: Int){ Return 1 + 1; }
        }
        Class B{
            $method(a: Int){ Return a + 1; }
            method2(){
